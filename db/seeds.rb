...
puts 'Creating Items...'
items = [
  { category: "Jardinage", name: "Scie Circulaire", picture: "app/assets/images/items_imagess/scie_circulaire.jpg", price: 15.00, description: "Scie circulaire performante pour tous vos travaux de découpe.", address: "123 Rue des Jardins, 40150 Hossegor", user: User.find_by(email: "lucie@gmail.com") },
  { category: "Jardinage", name: "Tondeuse", picture: "app/assets/images/items_imagess/tondeuse.jpg", price: 20.00, description: "Tondeuse puissante pour entretenir votre jardin facilement.", address: "124 Rue des Fleurs, 40150 Hossegor", user: User.find_by(email: "lucie@gmail.com") },
  ...
  { category: "Outils", name: "Perceuse", picture: "app/assets/images/items_imagess/perceuse.jpg", price: 10.00, description: "Perceuse robuste et facile à utiliser pour tous vos projets de bricolage.", address: "126 Avenue des Champs, 40150 Hossegor", user: User.find_by(email: "paul@gmail.com") },
  { category: "Outils", name: "Marteau", picture: "app/assets/images/items_imagess/marteau.jpg", price: 5.00, description: "Marteau durable pour tous vos travaux de construction et de réparation.", address: "127 Avenue des Pins, 40150 Hossegor", user: User.find_by(email: "paul@gmail.com") },
  ...
  { category: "Jardinage", name: "Taille-haie", picture: "app/assets/images/items_imagess/taille_haie.jpg", price: 18.00, description: "Taille-haie électrique pour tailler vos haies facilement.", address: "132 Rue des Cyprès, 40150 Hossegor", user: User.find_by(email: "snith@gmail.com") },
  { category: "Outils", name: "Clé à molette", picture: "app/assets/images/items_imagess/cle_a_molette.jpg", price: 7.00, description: "Clé à molette ajustable pour divers travaux de plomberie.", address: "133 Avenue des Oliviers, 40150 Hossegor", user: User.find_by(email: "snith@gmail.com") },
